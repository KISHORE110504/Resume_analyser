...
import nltk
nltk.data.path.append('nltk_data/corpora/stopwords')  # Specify your data path here
...
connection = pymysql.connect(host='localhost',user='root',password='Kish@1105',db='cv1')
...
def run():
    ...
    link = '[©Developed by Kishore anbu](https://www.linkedin.com/in/kishoreanbu/)'
    ...
    if choice == 'User':
        st.markdown('''<h5 style='text-align: left; color: #021659;'> Welcome to User Side. Upload your resume, and get smart recommendations</h5>''',
